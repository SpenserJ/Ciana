...
Ciana.prototype.start = function start() {
  ...
  self.io.sockets.on('connection', function(socket) {
    ...
    Object.keys(self.providers).forEach(function (provider_name) {
      ...
      templates = require('../providers/' + provider.name).toTemplate;
    ...
    Object.keys(self.providers).forEach(function (provider_name) {
      ...
      console.log('Reemitted for ' + provider_name + ' in ' + self.providers[provider_name].panel_name);
    });
  ...
  Object.keys(screen.panels).forEach(function(panel_name) {
    ...
    var ProviderModel = require('../providers/' + panel.provider).provider
